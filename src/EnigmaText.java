public abstract class EnigmaText {
    ...
    public static String numberOfRotorsTitle = "How many rotors would you like to use?";
    public static String selectionOfSettingsTitle = "Please select the settings";
    public static String switchBoardTitle = "Switch board set-up";
    public static String reflectorTitle = "Choose a reflector";
    public static String encryptTitle = "Encrypt a message";
    public static String decryptTitle = "Decrypt a message";
    public static String rotorSelection = "Rotor Selection";

    public static String encrypt = "Encrypt";
    public static String output = "Output: ";
    public static String decrypt = "Decrypt";
    public static String rotor = "Rotor: ";
    public static String rotorOffset = "Rotor Offset: ";
    ...
    public static String pathToRotors = "\\src\\RotorSetting.txt";
    public static String pathToReflectors = "\\src\\ReflectorSettings.txt";

    public static String lettersNotExisting = "The letters provided is not part of the alphabet";
    public static String missMatchWithOffsetsAndSettings = "There is a problem with the offsets and settings";
}
